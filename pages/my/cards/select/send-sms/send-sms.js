...
Page({
  ...
  checkboxChange: function (e) {
    ...
    if (phonenum.length == _this.data.phone.length) {
      this.onAllSelected()
    }
    _this.setData({
      phonenum
  ...
  onNext(){
    wx.redirectTo({ url: '/pages/my/cards/select/send-sms/select-temp/select-temp?phonenum='+phonenum})
  }
})